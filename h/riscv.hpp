...
class Riscv
        {
                public:
                    static void* commonFunc(int code, void* arg);
                ...
                // pop sstatus.spp and sstatus.spie bits (has to be a non inline function)
                    ...
                    // supervisor trap
                    static void supervisorInt();
                    static void sysCallExInt();
                    static void timerInt();
                    static void externInt();

                private:

                // supervisor trap handler
                    static void handleSysCallExInt();
                    static void handleTimerInt();
                    static void handleExternInt();
